...
setting.print_settings = {"heading"=>"YOUR DIAGNOSTIC CENTRE", "sub_heading"=>"DIAGNOSTIC ULTRASOUND UNIT", "address"=>"Opposite - Memorial Hospital, Balrampur", "phone_number"=>"232436", "consultant_1"=>"", "consultant_2"=>""}
...
30.times do
  rand(10..60).times do
    ...
    report = Report.new(patient: patient, doctor: doctor, updated_at: today, created_at: today)
