...
setting.print_settings = {"heading"=>"BALRAMPUR PATHOLGY XRAY & ULTRASOUND CENTRE", "sub_heading"=>"DIAGNOSTICS ULTRASOUND UNIT", "address"=>"INFRONT OF INDIAN OIL PETROL PUMP", "phone_number"=>"232436", "consultant_1"=>"Dr. ABDL. WAHID (MBBS)", "consultant_2"=>"Dr. K. B. GUPTA (MBBS)"}
