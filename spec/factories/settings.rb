FactoryGirl.define do
  ...
  factory :setting do
    print_settings "heading"=>"BALRAMPUR DIAGNOSTIC CENTRE", "sub_heading"=>"DIAGNOSTIC ULTRASOUND UNIT", "address"=>"Opposite - Memorial Hospital, Balrampur", "phone_number"=>"232436", "consultant_1"=>"", "consultant_2"=>""
    default_organ_findings "liver"=>"Appears NORMAL in size, shape & echotexture. No focal lesion or mass seen. Intrahepatic portal redicals are not Dilated. No Sub hepatic fluid seen.",
